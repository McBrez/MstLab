...
class SentinelConfig:
    ...
    # An integer that specifies in which intervall the measurement configuration
    # is switched. Interpreted as seconds.
    JSON_MEAS_CONTROL_SWITCH_TIMER = "MeasConfSwitchTimer"
